...
describe('Given authenticated users, user A, B and C', () => {
  ...
  describe("When user B replies to user A's tweet", () => {
    ...
    it('User B should see their reply when they call getTweets', async () => {
    ...
    it('User B should see their reply when they call getMyTimeline', async () => {
    ...
    describe("When user C replies to user B's reply", () => {
      ...
      it('User C should see their reply when they call getTweets', async () => {
        const { tweets } = await when.a_user_calls_getTweets(
          userC,
          userC.username,
          25
      ...
      it('User C should see their reply when they call getMyTimeline', async () => {
