...
const we_invoke_tweet = async (username, text) => {
  const handler = require('../../functions/tweet.js').handler;
...
const we_invoke_unretweet = async (username, tweetId) => {
  const handler = require('../../functions/unretweet.js').handler;
...
const we_invoke_reply = async (username, tweetId, text) => {
  const handler = require('../../functions/reply.js').handler;
...
const a_user_calls_unfollow = async (user, userId) => {
  const follow = `mutation unfollow($userId: ID!) {
